...
describe('Checkbox', () => {
  it('set all props', () => {
    const checkbox = shallow((
      <Checkbox name="Foo" value="Bar" id="Bar" checked />
    )).find('input');
  ...
  describe('disabled', () => {
    it('disable the checkbox when given by props', () => {
      const checkbox = shallow(<Checkbox name="Foo" disabled />).find('input');
  ...
  describe('label', () => {
    it('add a label when given by props', () => {
      const checkbox = mount(<Checkbox name="Foo" label="Bar" />);
  ...
  describe('radio', () => {
    it('change the input type to radio', () => {
      const checkbox = mount(<Checkbox name="Foo" type="radio" />);
