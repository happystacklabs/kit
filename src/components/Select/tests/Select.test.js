...
describe('Select', () => {
  it('set all props', () => {
    const selectInput = shallow((
      <Select name="Foo" value="Bar" options={[]} disabled />
    )).find('select');
  ...
  describe('options', () => {
    it('take an array of options into options object', () => {
      ...
      const selectInput = shallow(<Select name="Foo" value="" options={options} />);
  ...
  describe('onChange()', () => {
    it('is called with the new value', () => {
      const spy = jest.fn();
      const wrapper = mount(<Select name="foo" value="" options={[]} onChange={spy} />);
  ...
  describe('placeholder', () => {
    it('add a placeholder when given by props', () => {
      const selectInput = shallow((
        <Select name="Foo" value="" placeholder="Select" options={[]} />
      )).find('select');
  ...
  describe('helpText', () => {
    it('add a helpText when given by props', () => {
      const selectInput = mount((
        <Select name="Foo" value="" options={[]} helpText="Foo" />
      )).find('div');
  ...
  describe('label', () => {
    it('add a label when given by props', () => {
      const selectInput = mount((
        <Select name="Foo" value="" options={[]} label="Foo" />
      )).find('div');
