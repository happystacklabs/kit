...
describe('Switch', () => {
  it('render the toggle div', () => {
    ...
    expect(switchInput.find('div').at(1).hasClass('kit-switch')).toBe(true);
  });
  ...
  describe('color', () => {
    ...
    it('is main color when given by props', () => {
      ...
      expect(switchInput.find('div').at(1).hasClass('kit-switch--main')).toBe(true);
    });
  });
  ...
  describe('size', () => {
    it('show small when given by props', () => {
      ...
      expect(switchInput.find('div').at(1).hasClass('kit-switch--small')).toBe(true);
    });

    it('show medium when given by props', () => {
      const switchInput = shallow(<Switch size="regular" />);
      expect(switchInput.find('div').at(1).hasClass('kit-switch--medium')).toBe(true);
    });
