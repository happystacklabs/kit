...
var Switch = function (_Component) {
  ...
  _createClass(Switch, [{
    ...
    value: function render() {
      var classSwitch = cx({
        on: this.props.on,
        round: this.props.round }, _Switch2.default.switch, sizes[this.props.size], colors[this.props.color]);

      var classToggle = cx({
        on: this.props.on,
        round: this.props.round }, _Switch2.default.toggle, sizes[this.props.size]);
