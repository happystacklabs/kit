...
var Switch = function (_Component) {
  ...
  _createClass(Switch, [{
    ...
    value: function render() {
      var classes = cx(_Switch2.default.switch, {
        on: this.props.on,
        round: this.props.round
      });

      var wrapper = cx(this.props.className, sizes[this.props.size], colors[this.props.color]);
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement('div', { className: _Switch2.default.toggle })
        )
      );
    }
  }]);
