...
var choiceListViewerOptions = [{
  ...
  name: 'choices',
  value: [{ label: 'Alipay', value: 'alipay', helpText: 'Reccomended' }, { label: 'Wechat', value: 'wechat' }, { label: 'Paypal', value: 'paypal' }],
  type: 'array',
...
exports.default = choiceListViewerOptions;