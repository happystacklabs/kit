...
function renderContent(propSize, loading, plain, children) {
  if (loading) {
    ...
    var type = propSize === 'small' ? 'loader2' : 'loader1';
    type = plain ? 'loader2' : type;
    return _react2.default.createElement(
      'div',
      { className: 'kit-button__loading' },
      _react2.default.createElement(_Spinner2.default, { className: 'kit-button__spinner', color: 'ink-light', size: size, type: type }),
