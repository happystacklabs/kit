...
var Text = function (_Component) {
  ...
  _createClass(Text, [{
    ...
    value: function render() {
      ...
      var classText = (0, _classnames2.default)(this.props.className, _Text2.default.fontFamily, sizes[this.props.size], weights[this.props.weight], colors[this.props.color]);
