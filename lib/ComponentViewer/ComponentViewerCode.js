...
var copy = _interopRequireWildcard(_copyToClipboard);
...
var ComponentViewerCode = function (_Component) {
  ...
  function ComponentViewerCode() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ComponentViewerCode.__proto__ || Object.getPrototypeOf(ComponentViewerCode)).call.apply(_ref, [this].concat(args))), _this), _this.onClickCopy = function (event) {
      copy(_this.getCode());
      return;
  ...
  _createClass(ComponentViewerCode, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { className: 'viewerCode' },
        _react2.default.createElement(
          'div',
          { className: 'viewerCodeMenu' },
          _react2.default.createElement(
            _Text2.default,
            { size: 'small', color: 'inkLight', className: 'item' },
            'React'
          ),
          _react2.default.createElement(
            _Button2.default,
