...
var _Spinner = require('./Spinner.css');
...
var sizes = exports.sizes = {
  ...
  'regular': _Spinner2.default.regular,
...
var Spinner = function (_Component) {
  ...
  _createClass(Spinner, [{
    ...
    value: function render() {
      var classes = (0, _classnames2.default)(this.props.className, _Spinner2.default.spinner, types[this.props.type], colors[this.props.color], sizes[this.props.size]);
